...
.section __DATA, __bss
    .align 3
    m_read_buf:     .space BUF_SIZE                 // File read buffer
    ...
    m_out_buf:      .space 1024                     // Output RPN buffer
...
_minimize:
    ...
    ADRP    x1,         m_read_buf@PAGE
    ADD     x1, x1,     m_read_buf@PAGEOFF
    MOV     x20, x1                         // Save buffer address
    MOV     x2,         #BUF_SIZE
    LDR     x16,        =SYS_READ
    SVC                 #0x80
    B.CS    _m_error
